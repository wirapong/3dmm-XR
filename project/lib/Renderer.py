...
class Renderer:
    def __init__(self, **kwds):
        ...
        with open(kwds.get('vs', 'F:/KKU IS REASEARCH/project/shader/VertexShader.glsl'), encoding='utf-8') as f:
            self.vs = f.read()      #顶点着色器代码
        with open(kwds.get('fs', 'F:/KKU IS REASEARCH/project/shader/FragmentShader.glsl'), encoding='utf-8') as f:
    ...
    def show(self):
        ...
        glutCreateWindow(b'Data View Toolkit')
